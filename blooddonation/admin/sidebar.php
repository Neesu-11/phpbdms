...
<div class="sidebar" ><b>
  ...
  <a href="donor_list.php"   <?php if($active=='list') echo "class='act'"; ?>><span class="glyphicon glyphicon-list-alt"></span>&nbsp&nbsp Blood donor List</a>
  ...
  <a href="platelet_donor_list.php" <?php if($active=='platelets') echo "class='act'"; ?>><span class="glyphicon glyphicon-tint"></span>&nbsp&nbspPlatelets Donor</a>
