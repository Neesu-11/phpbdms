          ...
          <div class="row">
            <div class="col-md-3">
              <div class="panel panel-default panel-info" style="border-radius:0px;">
                <div class="panel-body panel-info bk-primary text-light" style="background-color:#D6EAF8; border-radius:0px">
            ...
            <div class="col-md-3">
              <div class="panel panel-default panel-info" style="border-radius:0px;">
                <div class="panel-body panel-info bk-primary text-light" style="background-color:#ABEBC6;border-radius:0px;">
                  <div class="stat-panel text-center">
                    <?php
            ...
            <div class="col-md-3">
              <div class="panel panel-default panel-info" style="border-radius:0px;">
                <div class="panel-body panel-info bk-primary text-light" style="background-color:#E8DAEF ;border-radius:0px; ">
                  <div class="stat-panel text-center">
                    <?php
